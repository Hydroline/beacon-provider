...
public final class MtrGetConnectionProfileActionHandler extends AbstractMtrActionHandler {
    public static final String ACTION = "mtr:get_connection_profile";
    ...
    public BeaconResponse handle(BeaconMessage message, TransportContext context) {
        ...
        JsonArray connections = MtrJsonWriter.writeConnectionProfiles(gateway.fetchConnectionProfiles(dimension));
        JsonObject payload = new JsonObject();
        payload.add("profiles", connections);
        if (dimension != null) {
