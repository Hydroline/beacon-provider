...
public final class MtrGetPlatformPositionMapActionHandler extends AbstractMtrActionHandler {
    public static final String ACTION = "mtr:get_platform_position_map";
    ...
    public BeaconResponse handle(BeaconMessage message, TransportContext context) {
        ...
        JsonArray positions = MtrJsonWriter.writePlatformPositions(gateway.fetchPlatformPositions(dimension));
        JsonObject payload = new JsonObject();
        payload.add("positions", positions);
        if (dimension != null) {
