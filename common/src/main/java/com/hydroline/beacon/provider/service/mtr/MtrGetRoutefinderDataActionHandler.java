...
public final class MtrGetRoutefinderDataActionHandler extends AbstractMtrActionHandler {
    public static final String ACTION = "mtr:get_routefinder_data";
    ...
    public BeaconResponse handle(BeaconMessage message, TransportContext context) {
        ...
        JsonArray data = MtrJsonWriter.writeRouteFinderData(gateway.fetchRouteFinderData(dimension));
